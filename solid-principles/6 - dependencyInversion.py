...
# Using Abstract class and passing it down
...
class DebitPaymentProcessor(PaymentProcessor):
    def __init__(self, securityCode, authorizer: Authorizer) -> None:
...
if __name__ == '__main__':
    ...
    processor = CreditPaymentProcessor('dgaerf794x', authorizer)
    authorizer.notARobot()
    processor.pay(newOrder)
